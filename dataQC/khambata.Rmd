...
The first eigen gene explains around 40\% of the variation. There appears to be major latent structure in these data, which cannot be explained any of the variables (particularly tissue) provided by experimentalists. Age and gender effects were then removed from the matrix.
...
sAdj <- fs(exprs(exprSetCorrected))
```
