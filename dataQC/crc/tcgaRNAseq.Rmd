...
#outputFilePath = file.path(tempdir(), "tcgaRNAseqQcedExpressionSet.rbin")
...
save(tcgaRNAseqQcedExpressionSet, file=file.path(tempdir(), "tcgaRNAseqQcedExpressionSet.rbin"))
```

This resulting R object is an `ExpressionSet` containing expression values on `r nrow(tcgaRNAseqQcedExpressionSet)` genes as well as clinical information on `r ncol(tcgaRNAseqQcedExpressionSet)` samples within the `phenoData` slot of the object.
