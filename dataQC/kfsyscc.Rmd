...
The gene-specific fitted values of age were removed from the expression matrix (gender information not available). SVD plots were repeated on this further normalized and summarized data to ensure no artifacts were introduced in this process.
