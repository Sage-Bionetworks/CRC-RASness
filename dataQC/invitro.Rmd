...
xyplot(s$v[,2] ~ s$v[,1], groups=factor(pData(exprSet)$cell_line),
       xlab="1st svd",
       ylab="2nd svd")
```

The first two eigen genes quite clearly separate into the three different cell lines HCT116, HT29, and SW480.
